 ...
 * @internal
 */
export declare type ServerClosure = {
    dynamodb: DynamoDB;
    models: {
...
export declare type SubscribeHandler = <T extends PubSubEvent>(...args: any[]) => SubscribePseudoIterable<T>;
...
export declare type MessageHandler<T> = (arg: {
 ...
 * @internal
 */
export declare type DDBType = Connection | Subscription;
